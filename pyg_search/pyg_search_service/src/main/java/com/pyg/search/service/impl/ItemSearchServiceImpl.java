...
public class ItemSearchServiceImpl implements ItemSearchService {
    ...
    public Map<String, Object> searchList(Map<String, Object> searchMap) {
        ...
        // 计算查询起始页
        Integer starNo = (pageNo - 1)*pageSize;
        // 设置分页
        ...
        // 执行查询
        HighlightPage<TbItem> hpage = solrTemplate.queryForHighlightPage(query, TbItem.class);

        // 获取高亮
        List<TbItem> content = hpage.getContent();
        // 循环搜索商品集合,获取高亮
        for (TbItem tbItem : content) {
            // 获取高亮
            List<HighlightEntry.Highlight> highlights = hpage.getHighlights(tbItem);
            // 判断高亮是否存在
